...
if __name__ == '__main__': 
    ...
    if data_type == 'MouseCortex':
        ...
        path = './corrections/MouseCortex/PointCloud/corrected_seg.npy'
        ...
        path = './corrections/SNEMI3D/Baseline/corrected_seg.npy'
        path = './corrections/SNEMI3D/perfect_correction.npy'
        seg = np.load(path).astype(np.int64)
        
    voi1, voi2 = voi(reconstruction = seg, groundtruth= gt, ignore_reconstruction=[0], ignore_groundtruth=[0])
    print('under_segmentation = ', voi1, '; over_segmentation = ' ,  voi2)
